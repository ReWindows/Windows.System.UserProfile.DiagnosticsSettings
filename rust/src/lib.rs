//! Windissect-generated Rust FFI bindings for Windows.System.UserProfile.DiagnosticsSettings.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "2BDBB469B52FAF1741E561DEEF8FE838";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 735369116;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 51] = [87, 105, 110, 100, 111, 119, 115, 46, 83, 121, 115, 116, 101, 109, 46, 85, 115, 101, 114, 80, 114, 111, 102, 105, 108, 101, 46, 68, 105, 97, 103, 110, 111, 115, 116, 105, 99, 115, 83, 101, 116, 116, 105, 110, 103, 115, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 735369116 { return 0; }
